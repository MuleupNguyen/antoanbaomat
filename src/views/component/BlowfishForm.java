...
public class BlowfishForm extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jCBPadding = new javax.swing.JComboBox<>();
        ...
        jCBSizeKey.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "256" }));
        ...
        jCBMode.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "ECB", "CBC", "CFB", "OFB", "CTR" }));
        jCBMode.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jCBModeActionPerformed(evt);
            }
        });
        ...
        jCBPadding.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "PKCS5", "ISO10126", "No" }));

        jLabel7.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        jLabel7.setText("Padding:");
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(jCBSizeKey, javax.swing.GroupLayout.PREFERRED_SIZE, 62, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
                .addComponent(jLabel6)
                .addGap(19, 19, 19)
                .addComponent(jCBMode, javax.swing.GroupLayout.PREFERRED_SIZE, 80, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(33, 33, 33)
                .addComponent(jLabel7)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jCBPadding, 0, 100, Short.MAX_VALUE)
                .addGap(34, 34, 34)
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(jCBMode, javax.swing.GroupLayout.PREFERRED_SIZE, 41, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(jTFKey, javax.swing.GroupLayout.PREFERRED_SIZE, 417, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jLabel1.setText("CIPHER  Blowfish");
    ...
    private void jButtonCreateKeyActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonCreateKeyActionPerformed
        ...
        try {
            ...
            Logger.getLogger(BlowfishForm.class.getName()).log(Level.SEVERE, null, ex);
        }
        jTFKey.setText(blowfish.getKey());
    ...
    private void jCBModeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCBModeActionPerformed
        // Lấy giá trị đã chọn trong ComboBox Mode
        String selectedMode = jCBMode.getSelectedItem().toString();

        // Kiểm tra giá trị đã chọn và điều chỉnh ComboBox Padding tương ứng
        if (selectedMode.equals("CTR")) {
            jCBPadding.removeAllItems();  // Xóa tất cả các mục trong ComboBox Padding
            jCBPadding.addItem("No");  // Thêm giá trị "NoPadding" vào ComboBox Padding
        } else {
            // Thêm các giá trị khác vào ComboBox Padding nếu cần
            jCBPadding.removeAllItems();
            jCBPadding.addItem("PKCS5");
            jCBPadding.addItem("ISO10126");
            jCBPadding.addItem("No");
        }
    }//GEN-LAST:event_jCBModeActionPerformed
    ...
    private javax.swing.JComboBox<String> jCBPadding;
